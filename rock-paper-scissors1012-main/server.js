...
var code_length = 1; 	// set this number between 1 to 5
var num_choices = 1; 		// this number must be greater or equal to code_length
var num_bet_attempts = 100000000000;
var num_classic_attempts = 100000000000;// change this number to have less or more attempts
...
app.post('/post', (req, res) => {
    ...
    //    if (num_match == code_length) win = true;
        ...
        var jsontext = JSON.stringify({
            'action' : 'evaluate',/*TODO 3 ... type of action */
            'win' : win,/*TODO 4 ... won or not */
           // 'num_match' : num_match,/*TODO 5 ... number of match*/
          //  'num_containing' : num_containing,/*TODO 6 ... number of correct colors*/
         //   'num_not_in' : num_not_in,/*TODO 7 ... number of wrong colors*/
            'code' : answer/*TODO 8 ... the answer code when the game ends*/
        });
        console.log(jsontext);
        res.send(jsontext);
    } else {
...
function generateCode(clientName) {
    //generate code
    const code = []; /*TODO 10 ... declare and initialize the code to an empty array*/
